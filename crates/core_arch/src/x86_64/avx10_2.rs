...
mod tests {
    ...
    unsafe fn test_mm_cvtts_roundsd_i64() {
    ...
    #[simd_test(enable = "avx10.2")]
    unsafe fn test_mm_cvtts_roundsd_si64() {
    ...
    #[simd_test(enable = "avx10.2")]
    unsafe fn test_mm_cvtts_roundsd_u64() {
    ...
    #[simd_test(enable = "avx10.2")]
    unsafe fn test_mm_cvtts_roundss_i64() {
    ...
    #[simd_test(enable = "avx10.2")]
    unsafe fn test_mm_cvtts_roundss_si64() {
    ...
    #[simd_test(enable = "avx10.2")]
    unsafe fn test_mm_cvtts_roundss_u64() {
