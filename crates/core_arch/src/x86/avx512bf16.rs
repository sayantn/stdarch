...
mod tests {
    ...
    fn test_mm_cvtne2ps_pbh() {
        ...
        let a: __m128 = unsafe { transmute(a_array) };
        let b: __m128 = unsafe { transmute(b_array) };
        let c: __m128bh = _mm_cvtne2ps_pbh(a, b);
        let result: [u16; 8] = *c.as_u16x8().as_array();
        #[rustfmt::skip]
    ...
    fn test_mm_mask_cvtne2ps_pbh() {
        ...
        let src: __m128bh = unsafe { transmute(src_array) };
        let a: __m128 = unsafe { transmute(a_array) };
        let b: __m128 = unsafe { transmute(b_array) };
    ...
    fn test_mm256_cvtne2ps_pbh() {
        ...
        let a: __m256 = unsafe { transmute(a_array) };
        let b: __m256 = unsafe { transmute(b_array) };
        let c: __m256bh = _mm256_cvtne2ps_pbh(a, b);
        let result: [u16; 16] = *c.as_u16x16().as_array();
        #[rustfmt::skip]
    ...
    fn test_mm256_mask_cvtne2ps_pbh() {
        ...
        let src: __m256bh = unsafe { transmute(src_array) };
        let a: __m256 = unsafe { transmute(a_array) };
        let b: __m256 = unsafe { transmute(b_array) };
    ...
    fn test_mm512_cvtne2ps_pbh() {
        ...
        let a: __m512 = unsafe { transmute(a_array) };
        let b: __m512 = unsafe { transmute(b_array) };
        let c: __m512bh = _mm512_cvtne2ps_pbh(a, b);
        let result: [u16; 32] = *c.as_u16x32().as_array();
        #[rustfmt::skip]
    ...
    fn test_mm512_mask_cvtne2ps_pbh() {
        ...
        let src: __m512bh = unsafe { transmute(src_array) };
        let a: __m512 = unsafe { transmute(a_array) };
        let b: __m512 = unsafe { transmute(b_array) };
    ...
    fn test_mm256_mask_cvtneps_pbh() {
        ...
        let result: [u16; 8] = *b.as_u16x8().as_array();
        #[rustfmt::skip]
        let expected_result: [u16; 8] = [
            0b0_10000110_0110010,
            0b0_10000010_0101000,
    ...
    fn test_mm_dpbf16_ps() {
        ...
        let a1: __m128 = unsafe { transmute(a_array) };
        let b1: __m128 = unsafe { transmute(b_array) };
        let src: __m128 = _mm_setr_ps(1.0_f32, 2.0_f32, 3.0_f32, 4.0_f32);
        let a: __m128bh = _mm_cvtne2ps_pbh(a1, a1);
        let b: __m128bh = _mm_cvtne2ps_pbh(b1, b1);
        let c: __m128 = _mm_dpbf16_ps(src, a, b);
        let result: [f32; 4] = *c.as_f32x4().as_array();
    ...
    fn test_mm256_dpbf16_ps() {
        ...
        let a1: __m256 = unsafe { transmute(a_array) };
        let b1: __m256 = unsafe { transmute(b_array) };
        #[rustfmt::skip]
        let src: __m256 = _mm256_setr_ps(
        ...
        let result: [f32; 8] = *c.as_f32x8().as_array();
        #[rustfmt::skip]
    ...
    fn test_mm512_dpbf16_ps() {
        ...
        let a1: __m512 = unsafe { transmute(a_array) };
        let b1: __m512 = unsafe { transmute(b_array) };
        let src: __m512 = _mm512_setr_ps(
        ...
        let result: [f32; 16] = *c.as_f32x16().as_array();
        #[rustfmt::skip]
    ...
    fn test_mm_cvtneps_pbh() {
        ...
        let r = _mm_cvtneps_pbh(a);
        let r: u16x4 = unsafe { transmute_copy(&r) };
    ...
    fn test_mm_mask_cvtneps_pbh() {
        ...
        let k = 0b1010;
        let r = _mm_mask_cvtneps_pbh(src, k, a);
        let r: u16x4 = unsafe { transmute_copy(&r) };
    ...
    fn test_mm_maskz_cvtneps_pbh() {
        let a = _mm_setr_ps(1.0, 2.0, 3.0, 4.0);
        let k = 0b1010;
        let r = _mm_maskz_cvtneps_pbh(k, a);
        let r: u16x4 = unsafe { transmute_copy(&r) };
