...
mod tests {
    ...
    fn test_mm512_broadcastmw_epi32() {
        let a: __mmask16 = 2;
    ...
    fn test_mm256_broadcastmw_epi32() {
        let a: __mmask16 = 2;
    ...
    #[simd_test(enable = "avx512cd")]
    fn test_mm512_broadcastmb_epi64() {
        let a: __mmask8 = 2;
    ...
    #[simd_test(enable = "avx512cd,avx512vl")]
    fn test_mm256_broadcastmb_epi64() {
        let a: __mmask8 = 2;
    ...
    #[simd_test(enable = "avx512cd")]
    fn test_mm512_mask_lzcnt_epi32() {
        let a = _mm512_set1_epi32(1);
    ...
    #[simd_test(enable = "avx512cd")]
    fn test_mm512_maskz_lzcnt_epi32() {
    ...
    #[simd_test(enable = "avx512cd,avx512vl")]
    fn test_mm256_mask_lzcnt_epi32() {
        let a = _mm256_set1_epi32(1);
    ...
    #[simd_test(enable = "avx512cd,avx512vl")]
    fn test_mm256_maskz_lzcnt_epi32() {
        let a = _mm256_set1_epi32(1);
    ...
    #[simd_test(enable = "avx512cd")]
    fn test_mm512_mask_lzcnt_epi64() {
        let a = _mm512_set1_epi64(1);
    ...
    #[simd_test(enable = "avx512cd")]
    fn test_mm512_maskz_lzcnt_epi64() {
    ...
    #[simd_test(enable = "avx512cd,avx512vl")]
    fn test_mm256_mask_lzcnt_epi64() {
        let a = _mm256_set1_epi64x(1);
    ...
    #[simd_test(enable = "avx512cd,avx512vl")]
    fn test_mm256_maskz_lzcnt_epi64() {
        let a = _mm256_set1_epi64x(1);
