...
features! {
    ...
    @FEATURE: #[unstable(feature = "avx512_target_feature_vex", issue = "44839")] avxifma: "avxifma";
    /// AVX-IFMA (Integer Fused Multiply Add)
    @FEATURE: #[unstable(feature = "avx512_target_feature_vex", issue = "44839")] avxneconvert: "avxneconvert";
    /// AVX-NE-CONVERT (Exceptionless Convert)
    @FEATURE: #[unstable(feature = "avx512_target_feature_vex", issue = "44839")] avxvnni: "avxvnni";
    /// AVX-VNNI (Vector Neural Network Instructions)
    @FEATURE: #[unstable(feature = "avx512_target_feature_vex", issue = "44839")] avxvnniint16: "avxvnniint16";
    /// AVX-VNNI_INT8 (VNNI with 16-bit Integers)
    @FEATURE: #[unstable(feature = "avx512_target_feature_vex", issue = "44839")] avxvnniint8: "avxvnniint8";
